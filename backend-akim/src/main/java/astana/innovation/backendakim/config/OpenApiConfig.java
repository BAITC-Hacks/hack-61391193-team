    ...
    OpenAPI simulationOpenApi() {
        return new OpenAPI().info(new Info()
                ...
                .description("Синтетическая модель хакатона: выберите ровно 5 мероприятий на бюджет до 100. "
                        ...
                        + "пример уже заполнен. Модель v2-saraishyk: 6 районов, включая Сарайшык, и 16 мероприятий. "
                        + "M15 (уборка снега) и M16 (ливневая канализация) используют синтетические стоимость, сроки и эффекты. "
                        + "Score примера = 56.31781049, базовый = 52.33242049. "
